...
class Inputfieldforpassword extends StatefulWidget {
  ...
  const Inputfieldforpassword({required this.first,required this.textController ,required this.hint,super.key});
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        suffixIcon:InkWell(
          ...
          child: (!showStatus)?Icon(Icons.visibility_sharp):(Icon(Icons.visibility_off)),
        )
      ),
